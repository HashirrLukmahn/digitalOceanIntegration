...
/**
 * Personal access token connection details.
 *
 ...
 */
export default function ApiTokenConnectionPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div>
        ...
        <h1 className="mt-3 text-lg font-semibold tracking-tight">Personal access token</h1>
